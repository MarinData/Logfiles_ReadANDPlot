function [varargout,hlines,hlgrd,hheads,hhgrd]=arrow3d(start,stop,col,ang,ltype,p,n)
%   Plot 3d Arrows
% 
...
%Set default data
if nargin<4 ang=30; end
if nargin<5 ltype='cylinder'; end
if nargin<6 p=[0.2,0.2]; end
if nargin<7 n=[30,20]; end
